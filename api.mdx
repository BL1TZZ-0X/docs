...
The request body varies depending on the transaction type:
...
<ParamField body="mint" type="string" required>
  The base58 mint address of the token.
</ParamField>
...
<ParamField body="amount" type="number" required>
  The amount of tokens in base units (6 decimals).
</ParamField>
...
<ParamField body="amount" type="number" required>
  The amount of SOL in lamports for the initial buy.
</ParamField>
...
#### Claim Creator Fees Transaction

<ParamField body="type" type="string" required>
  Must be `"claimCreatorFees"`.
</ParamField>
...
<ParamField body="creator" type="string" required>
  The base58 public key of the token creator claiming fees.
</ParamField>

<ParamField body="prioFee" type="number" required>
  The priority fee in SOL (e.g., `0.005`).
</ParamField>
...
The request body varies depending on the transaction type. All transaction types include:
...
<ParamField body="pool" type="string" required>
  The liquidity pool to use. Must be one of: `"pump"`, `"pump-amm"`, or `"auto"`.
</ParamField>
...
#### Create Transaction (Blitzz Mode)
...
#### Claim Creator Fees Transaction (Blitzz Mode)
...
<ParamField body="privateKey" type="string" required>
  The base58 private key of the token creator claiming fees.
</ParamField>
